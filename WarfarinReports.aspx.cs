...
public partial class WarfarinReports : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string location = Server.MapPath("Reports/Warfarin/");
    ...
    {
        string location = "Reports/Warfarin/";
        ...
        Response.Redirect("~/WarfarinReportView.aspx");
    }
}