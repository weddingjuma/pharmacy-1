...
public partial class TaskLogDetailsReports : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string location = Server.MapPath("Reports/TaskLogDetails/");
    ...
    {
        string location = "Reports/TaskLogDetails/";
        Session["StartDate"] = txtStartDate.Text;
        Session["EndDate"] = txtEndDate.Text;
        Session["ReportPathName"] = location + ddlReportName.SelectedItem.Value;
        Response.Redirect("~/TaskLogsDetailsReportView.aspx");
    }
}