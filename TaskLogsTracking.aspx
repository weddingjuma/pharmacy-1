    ...
    <div class="patientInfo">
        <div class="searchPatientDiv">
            <table>
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="Start Due Date:" ForeColor="White"></asp:Label>
                    </td>
                    <td>
            ...
            <fieldset>
                <ul>
                    ...
                    <li>
                        ...
                        H
                        <asp:DropDownList ID="ddlHour" runat="server" AppendDataBoundItems="True"></asp:DropDownList>
                        M
                        <asp:DropDownList ID="ddlMinutes" runat="server" AppendDataBoundItems="True"></asp:DropDownList>
                    ...
                    <li>
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="FrequencyDropdownsSeparator"></div>
                                <div class="FrequencyDropdowns">
                                    <label>If Weekly, what day?</label>
                                </div>
                                <div style="float: left">
                                ...
                                <div class="FrequencyDropdownsSeparator"></div>
                                <div class="FrequencyDropdowns">
                                    <label>If Monthly, what day?</label>
                                </div>
                                <div style="float: left">
