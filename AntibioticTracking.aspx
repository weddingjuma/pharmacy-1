<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AntibioticTracking.aspx.cs" Inherits="AntibioticTracking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="patientInfo">
        <div class="searchPatientDiv">
            ...
            <asp:HyperLink ID="hplAntibioticGuideline" runat="server" Target="_blank" 
                NavigateUrl="~/guidelines/AntibioticTreatmentReference.pdf" 
                Font-Underline="True" ForeColor="White">Antibiotic Treatment Reference</asp:HyperLink>
        </div>
    </div>
    <div class="patientInfo">
        ...
        <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="GetPatientsAntibioticTracking" 
